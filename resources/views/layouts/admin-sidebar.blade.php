<aside class="w-64 bg-[#f8fafc] border-r border-gray-100 flex-shrink-0 min-h-screen flex flex-col justify-between hidden md:flex transition-all">
    <div>
        ...
        <nav class="px-4 py-6 space-y-2">
            ...
            <a href="{{ route('admin.pengguna.index') }}" class="flex items-center px-4 py-3 rounded-xl font-bold text-sm transition-colors {{ request()->routeIs('admin.pengguna.*') ? 'bg-emerald-50/70 text-emerald-700 border-l-4 border-emerald-600' : 'text-gray-500 hover:bg-gray-100/50 hover:text-gray-800' }}">
                <svg class="w-5 h-5 mr-3 {{ request()->routeIs('admin.pengguna.*') ? 'text-emerald-600' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                Kelola Pengguna
            </a>
